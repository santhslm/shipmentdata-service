...
public class OAuthTokenHelper {
    ...
    public static String getToken() {
        try {
            ...
            claims.setClaim("client_id", "orion_dev"); // additional claims/attributes about the subject can be added
            claims.setStringListClaim("scope", newArrayList("orion:orion-dev")); // additional claims/attributes about the subject can be added
