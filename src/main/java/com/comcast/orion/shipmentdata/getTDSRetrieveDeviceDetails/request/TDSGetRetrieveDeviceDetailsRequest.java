...
public class TDSGetRetrieveDeviceDetailsRequest {
    ...
    public TDSGetRetrieveDeviceDetailsRequest withDeviceDetail(List<DeviceDetail> deviceDetail) {
        this.deviceDetail = deviceDetail;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TDSGetRetrieveDeviceDetailsRequest) == false) {
            return false;
        }
        TDSGetRetrieveDeviceDetailsRequest rhs = ((TDSGetRetrieveDeviceDetailsRequest) other);
